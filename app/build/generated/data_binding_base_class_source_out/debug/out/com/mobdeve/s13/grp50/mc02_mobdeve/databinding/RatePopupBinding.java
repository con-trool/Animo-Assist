...
public final class RatePopupBinding implements ViewBinding {
  @NonNull
  ...
  private RatePopupBinding(@NonNull LinearLayout rootView, @NonNull EditText feedbackInput,
      @NonNull TextView rateTitle, @NonNull ImageView star1, @NonNull ImageView star2,
  ...
  @NonNull
  public static RatePopupBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RatePopupBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.rate_popup, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RatePopupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RatePopupBinding((LinearLayout) rootView, feedbackInput, rateTitle, star1, star2,
          star3, star4, star5, submitRating);
    }
